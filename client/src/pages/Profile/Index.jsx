import { ProfileContainer, Input } from './styles'
...
export const Profile = () => {
     ...
     }, [username, email, password, image, pastEmail, strToday])
          ...
          <ProfileContainer>
               ...
               <div className="profile-grid">
                    <form className="change-form" onSubmit={(e) => handleUpdateInfos(e)}>
                         ...
                         <Input type="email" placeholder='New email' onChange={(e) => setEmail(e.target.value)} required />
                         <Input type="password" placeholder='New password' onChange={(e) => setPassword(e.target.value)} required />
                         <Input type="text" placeholder='New Image URL' onChange={(e) => handleImage(e)} />
                         <Input type="text" placeholder='New username' onChange={(e) => setUsername(e.target.value)} required />
